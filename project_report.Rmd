...
For the regression analysis we used the COVID-19 package in R as well as the noaa dataset. We created a separate dataset for the regression model and the predictive tool and pulled in the variables that we are interested in to run the analysis.
...
More formal analysis was done with [Regression Analysis](Regression-Analysis.html). Add more details on what that included
