...
Exploratory analysis was done in [Descriptives](descriptive_plotly.html) as well as [Interactive Dashboard Visualizations](create_shiny.html). The purpose and results were to see whether there are any differences between new daily COVID cases and deaths between states that are temperate and sub-tropical, red/blue states as per 2020 election, and between US cities among those are most populated compared to 10 randomly selected less populated counties.
