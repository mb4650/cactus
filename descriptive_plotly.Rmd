...
**Making the first plot: Look at trends of new COVID cases by state over the past year^I^.**
...
**Making the first plot: Look at trends of new COVID deaths by state over the past year^I^.**
...
ny_confirmed_plot =
  ...
  geom_line() +
  scale_y_continuous(labels = comma) +
  labs(title = "NYC/Less Populated NY Counties Covid Cases and Deaths",
       y = "Confirmed Cases",
       x = "Date") +
  scale_x_date(date_breaks = "1 month", date_labels = "%b-%y",expand = c(0,0)) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 0.5))
...
ca_confirmed_plot =
  ...
  geom_line() +
  scale_y_continuous(labels = comma) +
  labs(title = "LA/Less Populated CA Counties Covid Cases and Deaths",
       y = "Confirmed Cases",
       x = "Date") +
  scale_x_date(date_breaks = "1 month", date_labels = "%b-%y",expand = c(0,0)) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 0.5))
...
il_confirmed_plot =
  ...
  geom_line() +
  scale_y_continuous(labels = comma) +
  labs(title = "Cook County/Less Populated IL Counties Covid Cases and Deaths",
       y = "Confirmed Cases",
       x = "Date") +
  scale_x_date(date_breaks = "1 month", date_labels = "%b-%y",expand = c(0,0)) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 0.5))
...
tx_confirmed_plot =
  ...
  scale_y_continuous(labels = comma) +
  labs(title = "Houston/Less Populated TX Counties Covid Cases and Deaths",
       y = "Confirmed Cases",
       x = "Date") +
  scale_x_date(date_breaks = "1 month", date_labels = "%b-%y",expand = c(0,0)) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 0.5)) 
